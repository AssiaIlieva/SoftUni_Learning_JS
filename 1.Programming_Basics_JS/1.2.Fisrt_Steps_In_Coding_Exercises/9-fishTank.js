...
Изход Да се отпечата на конзолата едно число: •	литрите вода, които ще събира аквариума.
 */
function fishTank (input) {
    let lenghtDM = Number(input[0]) / 10;
    let widthDM = Number(input[1]) / 10;
    let hightDM = Number(input[2]) / 10;
    let percentSand = Number(input[3]) / 100;
    let totalTankVolume = lenghtDM * widthDM * hightDM;
    let litres = totalTankVolume - totalTankVolume * percentSand;
    console.log(litres);
}
